...
<?php
  ...
  */
  ...
  $MSG_Codes = "Codes";
  $MSG_SolutionVideo = "Solution Video";
  $MSG_WatchVideo = "Click To Watch The Video.";
  $MSG_ToggleSamples = "Toggle samples";
  $MSG_ShowAfterTrying = "Show after some trying";
  $MSG_AddSapmple = "Add a sapmple";
  $MSG_RemoveSample = "Remove the last sample";
  $MSG_SampleDataIsUpdated = "Sample data file Updated!";
  ...
  $MSG_Public="Public";
  $MSG_Private="Private";
  $MSG_Practice = "Practice";
  $MSG_Special = "Team only(Special)";
  $MSG_Running="Running";
  $MSG_Start="Start";
