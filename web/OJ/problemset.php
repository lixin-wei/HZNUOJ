...
SQL;
      ...
      $res = $mysqli->query("SELECT 1 ".$t_sql);
      $cnt += $res->num_rows;
      //count the number of problem END

      $t_sql = "SELECT problem.problem_id,`title`,author,`source`,`submit`,`accepted`,score, tag1, tag2, tag3, COUNT(running_problem.problem_id) > 0 AS locked  ".$t_sql;
